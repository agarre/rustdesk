...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Taking screenshot", "Tirando print"),
        ...
        ("New tab", "Próxima aba"),
        ("Keep terminal sessions on disconnect", "Manter "),
        ...
        ("Custom scale slider", "Controle de escala personalizada"),
        ("Decrease", "Diminuir"),
        ("Increase", "Aumentar"),
        ("Show virtual mouse", ""),
        ("Virtual mouse size", ""),
        ...
        ("Alias", "Apelido"),
        ("ScrollEdge", ""),
        ("Allow insecure TLS fallback", "Permitir fallback de TLS inseguro"),
        ("allow-insecure-tls-fallback-tip", ""),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", ""),
        ("server-oss-not-support-tip", ""),
        ("input note here", "digite nota aqui"),
        ("note-at-conn-end-tip", ""),
        ("Show terminal extra keys", "Exibir teclas extras do terminal"),
    ].iter().cloned().collect();
}
